...
application_confirmed = ("🔔✅ Работодатель принял ваш отклик на эту вакансию\n\n"
                         "• Скоро с вами свяжутся")

application_decline = "🔔❌ Работодатель отклонил ваш отклик на эту вакансию"
...
# Где используется???
no_application = "ℹ️ На эту вакансию у вас ещё нет откликов"

unverified_user = ("❗ Чтобы создавать вакансии необходимо подтвердить личность\n\n"
                   "• Пожалуйста, напишите разработчикам\n"
                   "  @TraffMinister\n"
                   "  @vlasom")
...
callback_in_creating_vacancy = "❗️ Для начала завершите или отмените создание, редактирование вакансии"
...
command_cancel_in_default_state = ("❌ Вам нечего отменять\n\n"
                                   "• Если меню с командами не обновилось, "
...
notification_buttons = { "tg": {0: "Telegram ❌", 1: "Telegram ✅"}, "email": {0: "Email ❌", 1: "Email ✅"}}


mail_verification = "Хорошо, укажите почту на которую вы хотите получать уведомления"
...
warning_msg = "❌ Данный тип сообщения не поддерживается"
