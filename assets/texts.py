welcome_text = lambda user_nickname, user_name: \
    f"Привет, <a href='@{user_nickname}'>{user_name}</a>! 👋\n"

employ_or_employer = ("Выбери что хочешь сделать ⬇️\n\n"
                      "• Смотреть самые актуальные вакансии от лица работника 👷‍♂️\n"
                      "  /show_vacancies\n\n"
                      "• Создать вакансию и ждать откликов 📅\n"
                      "  /create_vacancy")

employ_warn_info = ("При просмотре вакансий соблюдай простые правила ℹ️\n\n"
                    "• В откликах пиши по делу\n"
                    "• Составляй грамотные и понятные отклики\n"
                    "• Не используй нецензурную брань в откликах\n"
                    "• Не спамь\n\n"
                    "Пожалуйста, уважай себя и других пользователей бота ❗️")

no_vacancies_notification = ("Больше вакансий нет 🤷‍♂️\n\n"
                             "На данный момент ты просмотрел все актуальные вакансии.\n\n"
                             "Но мы можем уведомить тебя, когда появится новая вакансия 🆕")

no_vacancies_msg = ("Больше вакансий нет 🤷‍♂️\n\n"
                    "На данный момент ты просмотрел все актуальные вакансии.\n\n"
                    "Но ты можешь посмотреть эти же вакансии еще раз 🔂")

ok_bro_msg = "Хорошо. Когда вернёшься, просто напиши /main_page"
...
already_save_application = "Вы уже оставили свою заявку на эту вакансию, дожидайтесь ответа работодателя"
...
callback_in_creating_vacancy = "Для начала завершите или отмените создание вакансии"
callback_in_creating_application = "Для начала завершите или отмените создание заявки"
...
waning_u_are_stupid = "Что-то пошло не так. Возможно вы удалили или отредактировали сообщение"
